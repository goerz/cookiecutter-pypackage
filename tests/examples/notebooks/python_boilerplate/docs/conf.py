...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            '-o',
            str(DOCS / 'API'),
            os.path.join(DOCS / '..' / 'src' / 'python_boilerplate'),
        ]
    )
...
.. only:: html
    ...
    :raw-html:`<a href="http://nbviewer.jupyter.org/github/goerz/python_boilerplate/blob/<<GIT_TAG>>/{{ docname }}" target="_blank"><img alt="Render on nbviewer" src="https://img.shields.io/badge/render%20on-nbviewer-orange.svg" style="vertical-align:text-bottom"></a>&nbsp;<a href="https://mybinder.org/v2/gh/goerz/python_boilerplate/<<GIT_TAG>>?filepath={{ docname }}}" target="_blank"><img alt="Launch Binder" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>`
""".replace(
    '<<GIT_TAG>>', git_tag
)
