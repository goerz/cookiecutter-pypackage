...
Everyone interacting in the Python Boilerplate project's code base,
...
3. Check https://travis-ci.org/goerz/python_boilerplate/pull_requests
...
Ready to contribute? Follow `Aaron Meurer's Git Workflow Notes`_ (with ``goerz/python_boilerplate`` instead of ``sympy/sympy``)
...
Python Boilerplate uses a simple branching model where all
...
Python Boilerplate includes a full test-suite using pytest_.
...
.. _test coverage: https://coveralls.io/github/goerz/python_boilerplate?branch=master
...
At any point, from a checkout of the ``python_boilerplate``
...
:mod:`python_boilerplate` package:

.. doctest::

    >>> import python_boilerplate
    >>> python_boilerplate.__version__   # doctest: +SKIP
...
https://github.com/goerz/python_boilerplate/releases.
