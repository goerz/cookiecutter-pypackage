...
.. _test coverage: https://codecov.io/gh/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}
{%endif%}
...
At any point, from a checkout of the ``{{ cookiecutter.project_slug }}``
